...
<div class="leftside-menu">
    ...
    <a href="{{url('/dashboard')}}" class="logo text-center logo-light">
        <span class="logo-lg">
            <img src="{{ asset('inventory/logo') }}/{{$website_info->logo}}" alt="" height="50">
        </span>
        <span class="logo-sm">
            <img src="{{ asset('inventory/logo') }}/{{$website_info->logo}}" alt="" height="15">
        </span>
    </a>
    ...
    <a href="{{url('/dashboard')}}" class="logo text-center logo-dark">
        <span class="logo-lg">
            <img src="{{ asset('inventory/logo') }}/{{$website_info->logo}}" alt="" height="16">
        </span>
        <span class="logo-sm">
            <img src="{{ asset('inventory/logo') }}/{{$website_info->logo}}" alt="" height="16">
        </span>
