        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">@lang('add_income.index_title')</h4>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="roles-tab-all">
                            <table id="datatable-roles-all" class="table table-striped dt-responsive nowrap w-100">
                                <thead>
                                    <tr>
                                        <th>@lang('add_income.sl')</th>
                                        <th>@lang('add_income.date')</th>
                                        <th>@lang('add_income.title')</th>
                                        <th>@lang('add_income.amount')</th>
                        ...
                        $onlyTrashed = income_entry::leftjoin('income_expense_titles','income_expense_titles.id','income_entries.income_id')
                            ...
                            <table id="datatable-roles-deleted" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$v->amount}}</td>
                                        <td>
                                            <a href="{{url('retrive_income')}}/{{$v->id}}" class="btn btn-warning btn-sm"><i class="fa fa-rotate-right"></i> Retrive</a>
                                            <a onclick="return Confirm()" href="{{url('income_per_delete')}}/{{$v->id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Permenantly Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
