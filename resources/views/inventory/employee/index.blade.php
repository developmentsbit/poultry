        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">@lang('employee.index')</h4>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="roles-tab-all">
                            <table id="datatable-roles-all" class="table table-striped dt-responsive nowrap w-100">
                                <thead>
                                    <tr>
                                        <th>@lang('employee.sl')</th>
                                        <th>@lang('employee.name')</th>
                                        <th>@lang('employee.contact')</th>
                                        <th>@lang('employee.nid')</th>
                                        <th>@lang('employee.image')</th>
                                        <th>@lang('employee.nid_image')</th>
                        ...
                        $onlyTrashed = employee_info::onlyTrashed()->get();
                        @endphp
                            ...
                            <table id="datatable-roles-deleted" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$v->nid_no}}</td>
                                        <td>
                                            <a href="{{url('retrive_employee')}}/{{$v->id}}" class="btn btn-warning btn-sm"><i class="fa fa-rotate-right"></i> Retrive</a>
                                            <a onclick="return Confirm()" href="{{url('employee_per_delete')}}/{{$v->id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Permenantly Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
