                    ...
                    <form method="post" action="{{ route('asset_category.update',$data->id) }}">
                        ...
                        <div class="from-group row">
                            <div class="col-lg-4 col-md-4 col-12">
                                ...
                                <input type="text" class="form-control form-control-sm" name="title_en" id="title_en" required value="{{ $data->title_en }}">
                            </div>
                            <div class="col-lg-4 col-md-4 col-12">
                                <label for="title_bn">@lang('asset_category.title_bn')</label>
                                <input type="text" class="form-control form-control-sm" name="title_bn" id="title_bn" value="{{ $data->title_bn }}">
                            </div>
                            <div class="col-lg-4 col-md-4 col-12">
                            ...
                            <div class="col-12 text-right mt-2" style="text-align: right">
                                <button class="btn btn-sm btn-success"><i class="fa fa-save"></i> @lang('common.update')</button>
                            </div>
                        </div>
                    </form>
                </div> <!-- end card body-->
