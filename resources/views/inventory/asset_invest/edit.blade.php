...
<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{ route('asset_invest.update',$data->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="from-group row">
                            ...
                            <div class="col-lg-6 col-md-4 col-12 mt-2">
                                ...
                                <input type="number" class="form-control form-control-sm" name="amount" id="amount" required autocomplete="off" required value="{{ $data->amount }}">
                            </div>
