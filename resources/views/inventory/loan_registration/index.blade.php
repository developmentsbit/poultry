    ...
    @component('components.breadcrumb')
        ...
        @if (\App\Traits\RolePermissionTrait::checkRoleHasPermission('role', 'create'))
            ...
            @slot('action_button1_link')
                {{ route('loan_registration.create') }}
            @endslot
        @endif
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">@lang('loan_registration.index')</h4>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="roles-tab-all">
                            <table id="datatable-roles-all" class="table table-striped dt-responsive nowrap w-100">
                                <thead>
                                    <tr>
                                        <th>@lang('loan_registration.sl')</th>
                                        <th>@lang('loan_registration.name')</th>
                                        <th>@lang('loan_registration.phone')</th>
                                        <th>@lang('loan_registration.address')</th>
                        ...
                        $onlyTrashed = loan_register::onlyTrashed()
                        ->get();
                        @endphp
                            ...
                            <table id="datatable-roles-deleted" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{!! $v->address !!}</td>
                                        <td>
                                            <a href="{{url('retrive_loan_register')}}/{{$v->id}}" class="btn btn-warning btn-sm"><i class="fa fa-rotate-right"></i> Retrive</a>
                                            <a onclick="return Confirm()" href="{{url('delete_loan_register')}}/{{$v->id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Permenantly Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
    ...
    <script type="text/javascript">
        $(function () {
          var table = $('#datatable-roles-all').DataTable({
              processing: true,
              serverSide: true,
              ajax: "{{ route('loan_registration.index') }}",
              columns: [
                  {data: 'sl', name: 'sl'},
                  {data: 'name', name: 'name'},
