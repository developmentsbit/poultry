	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				...
				<form method="post" class="btn-submit" action="{{ route('loan_registration.update',$data->id) }}" enctype="multipart/form-data">
					@csrf
                    @method('PUT')
					...
					<div class="row myinput">
                        <div class="form-group mb-2 col-md-4">
							...
							<div class="input-group">
								<input class="form-control" type="text" name="name" id="name"  required="" placeholder="@lang('loan_registration.name')" value="{{$data->name}}">
							</div>
						</div>
						...
						<div class="form-group mb-2 col-md-4">
							...
							<div class="input-group">
								<input class="form-control" type="number" name="phone" id="phone" required="" placeholder="@lang('loan_registration.phone')" value="{{$data->phone}}">
							</div>
						</div>
						...
						<div class="form-group mb-2 col-md-8">
							...
							<div class="input-group">
								<textarea class="form-control" rows="3" name="address" id="address" placeholder="@lang('loan_registration.address')">{!! $data->address !!}</textarea>
							</div>
						</div>
