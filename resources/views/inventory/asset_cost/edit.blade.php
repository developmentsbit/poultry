...
<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{ route('asset_cost.update',$data->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="from-group row">
                            <div class="col-lg-4 col-md-4 col-12">
                                <label for="date">@lang('asset_cost.date')</label><span class="text-danger">*</span>
                                <input type="text" class="form-control form-control-sm" name="date" id="datepicker" required autocomplete="off" value="{{ Date::DbtoDate('-',$data->date) }}">
                            </div>
                            <div class="col-lg-4 col-md-4 col-12">
                                ...
                                <select class="form-select form-select-sm" name="title_id" id="title_id" required>
                                    ...
                                    <option @if($data->title_id == $c->id) selected @endif value="{{ $c->id }}">
                            ...
                            <div class="col-lg-4 col-md-4 col-12">
                                ...
                                <input type="number" class="form-control form-control-sm" name="amount" id="amount" required autocomplete="off" value="{{ $data->amount }}" required>
                            </div>
