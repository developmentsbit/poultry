	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				...
				<h3>Withdraw CC Loan<a href="{{ route('bank_transaction.index') }}" class="btn btn-success float-end rounded addbutton"><i class="fa fa-eye"></i>&nbsp;@lang('bank_transaction.index')</a></h3><br>

				<form method="post" class="btn-submit" action="{{ url('withDrawCCloan') }}">
					@csrf
                    <div class="row">
