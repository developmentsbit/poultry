	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				...
				<form method="post" class="btn-submit" action="{{ route('income_expense_title.store') }}">
					@csrf
					...
					<div class="row myinput">
						...
						<div class="form-group col-md-6 mb-2">
							...
							<div class="input-group">
								...
								<input class="form-control" type="text" name="title_en" id="title_en"  required="" placeholder="@lang('item.name_en')">
							</div>
						</div>
						<div class="form-group col-md-6 mb-2">
							...
							<div class="input-group">
								...
								<input class="form-control" type="text" name="title_bn" id="title_bn" placeholder="@lang('item.name_bn')">
							</div>
						</div>
