...
<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{ route('asset_depreciation.update',$data->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="from-group row">
                            <div class="col-lg-6 col-md-6 col-12">
                                ...
                                <select class="form-select form-select-sm" name="title_id" required>
                                    ...
                                    <option @if($data->title_id == $c->id) selected @endif value="{{ $c->id }}">{{ $c->title_en }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <label for="depreciation_value">@lang('asset_dep.depreciation_value')</label>
                                <input type="number" class="form-control form-control-sm" name="depreciation_value" id="depreciation_value" required value="{{ $data->depreciation_value }}">
                            </div>
