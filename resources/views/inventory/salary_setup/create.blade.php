	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				...
				<form method="post" class="btn-submit" action="{{ route('salary_setup.store') }}">
					@csrf
					...
					<div class="row myinput">
						...
						<div class="form-group col-md-6 mb-2">
							...
							<div class="input-group">
								...
								<input class="form-control" type="text" name="employee_salary" id="employee_salary" placeholder="@lang('salary_setup.employee_salary')" required>
							</div>
						</div>
