...
<div class="container-fluid mt-2">
	<div class="card">
		...
		<h3>Customer Payment  <a href="{{ route('customer_payment.index') }}" class="btn btn-success float-end rounded addbutton"><i class="fa fa-eye"></i>&nbsp;All Customer Payment</a></h3>
