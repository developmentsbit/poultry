...
@endphp
  ...
  <div class="invoice">
    ...
    <table>
        <tr>
            <td colspan="3">
                ...
                <span>Customer Name : </span> <b>{{$data->customer_name_en}}, {{$data->customer_phone}}</b><br>
        ...
        <tr>
            <td style="width : 10%;">{{$data->entry_date}}</td>
            <td>
                {{$data->note}}
            </td>
            <td style="width : 10%;">{{$data->payment_amount}}</td>
        </tr>
        <tr style="border: none !important;">
            <td colspan="2" style="border: none !important;">Total</td>
            <td style="border: none !important;"><b>{{$data->payment_amount}}</b></td>
        </tr>
        <tr style="border: none !important;">
    ...
    <span class="note p-4">
      <span style="text-transform: capitalize;"><b>In Word:</b> @php echo ' '.  NumberToWords::transformNumber('en', $data->payment_amount); @endphp   tk only</span>
    </span>
