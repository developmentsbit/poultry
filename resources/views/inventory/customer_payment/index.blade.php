...
<div class="container">
    ...
    @component('components.breadcrumb')
        @slot('title')
            @lang('customer_payment.index_title')
        @endslot
        @slot('breadcrumb1')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">@lang('customer_payment.index_title')</h4>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="roles-tab-all">
                            <table id="datatable-roles-all" class="table table-striped dt-responsive nowrap w-100">
                                <thead>
                                    <tr>
                                        <th>@lang('customer_payment.invoice_no')</th>
                        ...
                        $onlyTrashed = sales_payment::leftjoin('customer_infos','customer_infos.customer_id','sales_payments.customer_id')
                            ...
                            <table id="datatable-roles-deleted" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('retrive_customer_payment')}}/{{$v->id}}" class="btn btn-warning btn-sm"><i class="fa fa-rotate-right"></i> Retrive</a>
                                            <a onclick="return Confirm()" href="{{url('customer_payment_perdelete')}}/{{$v->id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Permenantly Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
    ...
    <script type="text/javascript">
        $(function () {
          var table = $('#datatable-roles-all').DataTable({
              processing: true,
              serverSide: true,
              ajax: "{{ route('customer_payment.index') }}",
              columns: [
