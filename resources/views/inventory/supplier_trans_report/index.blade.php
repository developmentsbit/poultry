	...
	<div class="col-12">
		...
		<div class="card">
			<div class="card-body">
				...
				<h3>@lang('supplier_trans_report.supplier_trans_report')</h3><br>

				<form method="get" class="btn-submit" action="{{ url('show_supplier_trans_report') }}" enctype="multipart/form-data" target="_blank">
					...
					<div class="row myinput">
						...
						<div class="form-group col-md-4 mb-2">
							...
							<div class="input-group">
								...
								<input class="form-control" type="date" name="from_date" id="from_date"  required="" value="{{ date('Y-m-d') }}">
							</div>
						</div>
						<div class="form-group col-md-4 mb-2">
                        ...
                        <div class="form-group col-md-4 mb-2">
							...
							<div class="input-group">
								<select class="form-control js-example-basic-single" name="supplier_id" id="supplier_id" required>
									@if($supplier)
                                    @foreach ($supplier as $b)
                                    <option value="{{$b->supplier_id}}">{{$b->supplier_name_en}} - {{$b->supplier_phone}}</option>
                                    @endforeach
                                    @endif
								</select>
							</div>
