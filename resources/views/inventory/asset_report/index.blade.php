...
<div class="container mt-2">
	<div class="col-12">
		<div class="card">
			<div class="card-body">
                <h4>Asset Report</h4><br>
                <form method="get" target="_blank" action="show_asset_report">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12 mt-2">
                            <label for="category">Asset Title</label>
                            <select class="form-control form-control-sm js-example-basic-single" name="title_id" id="title_id" required>
