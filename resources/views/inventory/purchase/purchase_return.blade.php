	...
	<div class="container-fluid mt-2">
		<div class="card">
			<div class="card-body">
				...
				<h3>Purchase  Information<a href="{{ route('purchase.index') }}" class="btn btn-success float-end rounded addbutton"><i class="fa fa-eye"></i>&nbsp;All Purchase</a></h3><br>
                        <form method="post" class="btn-submit" id="" action="{{url('purchase_return_submit')}}">
                            @csrf
                            ...
                            <div class="col-md-12 p-0 row">
                                ...
                                <div class="form-group mb-2 col-md-4">
                                    ...
                                    <b>{{$data->supplier_name_en}}</b> ({{$data->supplier_phone}})
                                </div>
                                <div class="form-group mb-2 col-md-4">
...
<script>
        ...
        function getcurrentpurchasereturn()
        {
            ...
            $.ajax({
                ...
                url : '{{ url('getcurrentpurchasereturn') }}/'+invoice_no,
        ...
        getcurrentpurchasereturn();

    });

    function purchaseqtyupdate(id)
    {
        var qty = $('#return_quantity'+id).val();
        $.ajax({
            headers : {
                'X-CSRF-TOKEN' : '{{csrf_token()}}'
            },

            url : '{{url('purchaseqtyupdate')}}/'+id,
    ...
    function deleteCurrentReturnpurchase(id)
    {
        var element = this;
        if(confirm("Are You Sure?"))
        {
            ...
            $.ajax({
                ...
                url : '{{url('deleteCurrentReturnpurchase')}}/'+id,
