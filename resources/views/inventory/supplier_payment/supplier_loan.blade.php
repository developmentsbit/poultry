...
<div class="container-fluid mt-2">
	<div class="card">
		...
		<h3>Supplier Loan <a href="{{ route('supplier_payment.index') }}" class="btn btn-success float-end rounded addbutton"><i class="fa fa-eye"></i>&nbsp;All Supplier Payment</a></h3>

        <form method="post" class="" action="{{url('supplier_loan_payment')}}">
            @csrf
