        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">@lang('loan_provide.index')</h4>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="roles-tab-all">
                            <table id="datatable-roles-all" class="table table-striped dt-responsive nowrap w-100">
                                <thead>
                                    <tr>
                                        <th>@lang('loan_provide.sl')</th>
                                        <th>@lang('loan_provide.date')</th>
                                        <th>@lang('loan_provide.name')</th>
                                        <th>@lang('loan_provide.amount')</th>
                        ...
                        $onlyTrashed = loan_provide::leftjoin('loan_registers','loan_registers.id','loan_provides.register_id')
                        ->onlyTrashed()
                            ...
                            <table id="datatable-roles-deleted" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$v->amount}}</td>
                                        <td>
                                            <a href="{{url('retrive_loan_provide')}}/{{$v->id}}" class="btn btn-warning btn-sm"><i class="fa fa-rotate-right"></i> Retrive</a>
                                            <a onclick="return Confirm()" href="{{url('delete_loan_provide')}}/{{$v->id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Permenantly Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
